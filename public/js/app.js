...
var queryString = window.queryString = __webpack_require__(62);

var serializer = __webpack_require__(46).serialize;
            ...
            window.parentApp.$modal.confirm({
                ...
                onOk: function onOk() {
                    return axios.delete(el.href || el.action, {
                        data: (0, _assign2.default)({}, binding.value && binding.value.data || {}, el.tagName === 'FORM' ? serializer(el) : {})
                    }).then(function (res) {
                        if (res.data.code > 1) {
                            window.parentApp.$modal.error({
                                title: '提示',
...
window.app = new Vue({
    ...
    methods: {
        listData: function listData(params) {
            var _this = this;

            return new _promise2.default(function (resolve) {
                console.log(_this.list.total);
                resolve({
                    total: _this.list.total,
                    results: _this.list.data
                });
            });
        },
        ...
        pageShowTotal: function pageShowTotal(total, pages) {
    ...
    beforeCreate: function beforeCreate() {
        ...
        arr.splice(4, 0, '#');
        arr.splice(0, 4);
        window.top.history.replaceState('', '', arr.join('/'));
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_matches_selector__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_matches_selector___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_matches_selector__);
    ...
    if (options.ignoredTypes) {
      ...
      try {
        for (var _iterator = options.ignoredTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (__WEBPACK_IMPORTED_MODULE_0_matches_selector___default()(el, selector)) {
            foundInIgnored = true;
          }
        }
      } catch (err) {
