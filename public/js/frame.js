...
window.app = new Vue({
    ...
    mounted: function mounted() {
        ...
        document.body.addEventListener('click', function (e) {
            if (e.target.tagName === 'A' && e.target.closest('#sidebar .ant-menu-root')) {
                ...
                if (e.target.href.indexOf('#') === -1) {
                    ...
                    iframe.setAttribute('src', _bootstrap2.default.getRoot() + e.target.href.substring(e.target.href.indexOf('#') + 2));
        ...
        if (location.hash.indexOf('#/') !== -1) {
            iframe.setAttribute('src', _bootstrap2.default.getRoot() + location.hash.substr(2));
        } else {
            iframe.setAttribute('src', _bootstrap2.default.getRoot() + 'home');
        }
    }
});
